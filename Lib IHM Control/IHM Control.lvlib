...
<Library LVVersion="13008000">
	...
	<Item Name="Front Panel Status.ctl" Type="VI" URL="../Front Panel Status.ctl"/>
	<Item Name="MHL UI Ref.ctl" Type="VI" URL="../MHL UI Ref.ctl"/>
	<Item Name="Set enable state on multiple controle.vi" Type="VI" URL="../Set enable state on multiple controle.vi"/>
